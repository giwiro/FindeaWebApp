...
;(function ($, window, document, navigator) {
    ...
    $(document).ready(function () {
        ...
        $(document).find("[data-" + pluginName + "-bg]").each(function (i, element) {
            ...
            //Se evalúa si es de tarde para cambiar el bg
            var $children = $($element.children()[0]),
                hora = new Date().getHours();

            console.log("hora",hora, $element.hasClass("afternoon"));
            if ($element.hasClass("afternoon") && (hora >= 18 || hora <= 6)) {
                var r =(["","4"])[Math.round(Math.random())]
                $children.css("background-image", "url(/video/video-bg" + r + ".jpg)");
            }

            console.log(i, $children,hora >= 18 || hora <= 6);
        });
    });
